...
TEST_DATA_DIR=$EXP_HOME/data/bingrad_sound/testset
STAGE_DIR=$EXP_HOME/checkpoints/single_sound
...
for subject_dir in "$TEST_DATA_DIR"/*/; do
  ...
  CUDA_VISIBLE_DEVICES=7 python src/binauralgrad/inference.py --fast ${STAGE_DIR}/weights.pt \
