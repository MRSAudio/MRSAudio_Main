...
def get_args():
    ...
    # task
    parser.add_argument('--class-num', type=int, default=32, help='Total number of target classes, 13 is default for DCASE2023 Task3.')
    ...
    # net
    parser.add_argument('--net', '-n', default='crnn', choices=['crnn', 'vis_transformer'], help='Neural network architecture.')
    # optimizer
    ...
    parser.add_argument('--model-save-interval', '-s', type=int, default=500, help='The interval of saving model parameters.')
    # feature
    parser.add_argument('--sampling-frequency', '-fs', type=int, default=24000, help='Sampling frequency.')
    parser.add_argument('--feature', default='amp_phasediff', choices=['amp_phasediff', 'binaural_phasediff'], help='Input audio feature type.')
